    ...
    if 'usersessionid' in session:
        ...
        if request.method=='POST':
            try:
                ...
                print (err)
            return render_template('customersearch.html',session=session, form=mycustomersearchform ,productdetails=productdetails)
...
def customer():
    ...
    if 'usersessionid' in session:
        ...
        if request.method=='PUT':
            ...
            return render_template('customer.html',session=session, form=mycustomerform)
    else:
        return redirect (url_for('login'))
