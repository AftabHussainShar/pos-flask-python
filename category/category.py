    ...
    if 'usersessionid' in session:
        ...
        if request.method=='POST':
            try:
                ...
                print (err)
            return render_template('categorysearch.html',session=session, form=mycategorysearchform ,productdetails=productdetails)
...
def category():
    ...
    if 'usersessionid' in session:
        ...
        if request.method == 'PUT':
            ...
            return render_template('category.html', session=session,form=mycategoryform)
    else:
        return redirect (url_for('login'))
