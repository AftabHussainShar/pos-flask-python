    ...
    if 'usersessionid' in session:
        ...
        if request.method=='POST':
            try:
                ...
                print (err)
            return render_template('warehousesearch.html',session=session, form=mywarehousesearchform ,productdetails=productdetails)
...
def warehouse():
    ...
    if 'usersessionid' in session:
        ...
        if request.method == 'PUT':
            ...
            return render_template('warehouse.html', session=session,form=mywarehouseform)
    else:
        return redirect (url_for('login'))
