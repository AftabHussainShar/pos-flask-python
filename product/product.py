...
def product():
    ...
    if 'usersessionid' in session:
        ...
        if request.method == 'PUT':
            ...
            return render_template('product.html',session=session, form=myproductform)
    else:
    ...
    if 'usersessionid' in session:
        ...
        if request.method=='POST':
            try:
                ...
                print (err)
            return render_template('productsearch.html',session=session, form=myproductsearchform ,productdetails=productdetails)
