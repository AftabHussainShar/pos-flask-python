    ...
    if 'usersessionid' in session:
        if myposform.validate_on_submit():
            if request.method=='POST':
                ...
                return render_template('pos.html',session=session, form=myposform)
    ...
    if 'usersessionid' in session:
        ...
        if request.method=='POST':
            try:
                ...
                print (err)
            return render_template('accounts/possearch.html',session=session, form=mypossearchform ,productdetails=productdetails)
        ...
        if request.method=='GET':
            ...
            try:
                ...
                print (err)
            # productdetails = cursor.fetchall()
            return render_template('possearch.html', session=session,form=mypossearchform ,productdetails=productdetails)
    else:
        return redirect (url_for('login'))
